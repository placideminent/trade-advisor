...
WEIGHT_FIELDS = [
    ...
    ("chg6_100", "6개월 상승 100%", "6개월 전 대비 100% 이상 600% 미만 −2 (모든 조회)"),
    ("chg6_600", "6개월 상승 600%", "6개월 전 대비 600% 이상 −3 (모든 조회)"),
...
def recommend(
    ...
    **_unused,
    ...
    if chg6 is None:
        ...
        add("6개월 상승률", f"{chg6 * 100:.1f}% (100% 이상 600% 미만)", wp("chg6_100"))
    elif chg6 >= 0.50:
