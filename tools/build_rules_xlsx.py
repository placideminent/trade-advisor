...
def main() -> None:
    ...
    add_sheet(
        ...
        [
            ...
            ["추세선 방향", "하락 추세선 상승 추세선 모두 하락이면서 현재가가 하락 추세선 근처일때", -1],
            ["추세선 방향", "하락 추세선 상승 추세선 모두 하락이면서 현재가가 하락 추세선을 돌파했을 때", 1],
            ["추세선 방향", "상승 추세선이 상승이면서 현재가가 상승 추세선에 근접했을 때", 1],
            ["상승 추세선 이탈", "상승 추세선이 완만하거나 상승추세선이 하방이면서 현재가가 상승추세선을 완전 이탈했을 때", -1],
            ...
            ["20일선", "현재가가 20일선보다 아래이고, 상승추세선이 상방향일때", 1],
            ["20일선", "현재가가 20일선보다 아래이고, 상승 추세선이 하방향일때", -1],
            ["20일선", "현재가가 20일선보다 아래이고, 횡보일 때", 0],
            ["180일선", "현재가가 장기 이평 근처일 때. 6개월 조회는 180일선, 1년 조회는 300일선", 1],
            ["1개월 상승률", "한 달 동안 50% 이상 오름", -1],
            ["1개월 하락률", "한 달동안 10% 이상 30%미만 하락 했을 때", 1],
            ["1개월 하락률", "한 달 동안 30% 이상 40% 미만 떨어짐", 2],
            ["1개월 하락률", "한 달 동안 40% 이상 떨어짐", 3],
            ["6개월 상승률", "6개월 동안 800% 이상 오름", -3],
            ["6개월 상승률", "6개월 동안 500% 이상 800% 미만 오름", -2],
            ["6개월 상승률", "6개월 동안 200% 이상 500% 미만 오름", -1],
