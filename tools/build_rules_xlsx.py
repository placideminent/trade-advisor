...
def main() -> None:
    ...
    how_lines = [
        ...
        "2. 더한 점수를 %로 바꿉니다. 0점이면 0%, 15점(기본)이면 50%, 30점이면 100%.",
        "3. %로 매수 / 매도 / 홀딩을 정합니다.",
    ...
    add_sheet(
        ...
        [
            ...
            ["신고가 달성", "6개월 상승률이 800% 미만이면서 위에 저항이 없는 신고가의 경우", 1],
            ["신고가 저항", "6개월 상승률이 800% 이상이면서 위에 저항이 없는 신고가의 경우", -1],
            ["신고가 이탈", "신고가 돌파 후 다시 하락 추세선 안으로 현재가가 내려왔을 때", -1],
        ],
        [18, 72, 10],
    )
