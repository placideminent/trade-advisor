...
def main() -> None:
    ...
    how_lines = [
        ...
        "2. 더한 점수를 %로 바꿉니다. 1점이면 0%, 15점(기본)이면 50%, 30점이면 100%.",
        "3. %로 매수 / 매도 / 홀딩을 정합니다.",
    ...
    add_sheet(
        ...
        [
            ...
            ["신고가 이탈", "신고가 돌파 후 3봉 이내에 다시 하락 추세선 안으로 현재가가 내려왔을 때, 3봉 이후 무효", -1],
        ],
        [18, 72, 10],
    )
    ...
    cuts["A11"] = "점수를 %로 바꾸는 법: 1점이면 0%, 15점(기본)이면 50%, 30점이면 100%."
