...
원하는 **날짜 시점**의 시세로 추세선, 지지/저항, 주요 매물대를 계산하고
**매수 / 매도 / 홀딩**을 제안하는 Streamlit 앱입니다.
조회 기간은 1개월(1시간봉), 2·3개월(4시간봉), 6개월·1년(일봉)입니다.
...
- **봉 종류**: 1개월은 1시간봉, 2·3개월은 4시간봉, 6개월·1년은 일봉.
- **매물대**: 각 봉의 고가~저가 구간에 거래량을 나눠 쌓은 가격대 히스토그램.
